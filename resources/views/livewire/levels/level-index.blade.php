<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('المستوى') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('إدارة المستويات') }}</flux:subheading>
    ...
    <div>
        ...
        @endsession
        {{-- @can('eduexp.create') --}}
            <a href="{{ route("level.create") }}" class="cursor-pointer px-3 py-2 text-xs font-medium text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                انشاء مستوى
            </a>
        {{-- @endcan --}}
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-2">
                                ...
                                {{-- @can('eduexp.edit') --}}
                                    ...
                                    <flux:button
                                        href="{{ route('level.edit',$item->id) }}" icon="pencil" variant="primary">
                                    </flux:button>
                                {{-- @endcan --}}
                                {{-- @can('eduexp.delete') --}}
