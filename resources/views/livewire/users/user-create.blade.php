<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('New User') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <flux:input wire:model="email" label="Email" type="email" description="This will be publicly displayed." />
                <flux:input wire:model="password" label="Password" type="password" description="This will be publicly displayed." />
                <flux:input wire:model="confirm_password" label="Confirm Password" type="password" description="This will be publicly displayed." />
