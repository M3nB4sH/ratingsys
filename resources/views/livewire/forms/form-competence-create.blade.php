<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('اضافة تقويم كفايات') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('اضافة تقويم كفايات جديد') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <flux:checkbox.group id="competences" wire:model="competences" label="اختر الكفايات">
                ...
                <flux:radio.group wire:model="filmname" label="هل تريد إضافة اسم القصة أو الفيلم التعليمي">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
