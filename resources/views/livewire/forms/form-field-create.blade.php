<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('اضافة تقويم') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('اضافة تقويم جديد') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <flux:checkbox.group id="fields" wire:model="fields" label="اختر المجالات">
                ...
                <flux:radio.group wire:model="activitytype" label="هل تريد إضافة نوع النشاط">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="period" label="هل تريد إضافة الفترة">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="general" label="هل تريد إضافة الهدف العام">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="goals" label="هل تريد إضافة الاهداف السلوكية">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="report" label="هل تريد إضافة التقرير الوصفي">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="activityshow" label="هل تريد إضافة أسلوب عرض النشاط">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
                </flux:radio.group>
                <flux:radio.group wire:model="activitygoals" label="هل تريد إضافة الأهداف التي تم تحقيقها من خلال النشاط">
                    <div class="flex gap-4 *:gap-x-2">
                        <flux:radio label="نعم" value="1"/>
                        <flux:radio label="لا" value="0"/>
                    </div>
