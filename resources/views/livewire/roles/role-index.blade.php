<div>
    ...
    <div>
        ...
        @endsession
        @can('role.create')
            <a href="{{ route("role.create") }}" class="cursor-pointer px-3 py-2 text-xs font-medium text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                Create Role
            </a>
        @endcan
                ...
                <tbody>
                    @foreach ($items as $item)
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-2">
                                {{-- @can('role.view')
                                    <a href="{{ route("role.show",$item->id) }}" class="mr-1 cursor-pointer px-3 py-2 text-xs font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        Show
                                    </a>
                                @endcan --}}
                                @can('role.edit')
                                    ...
                                    <flux:button
                                        href="{{ route('role.edit',$item->id) }}" icon="pencil" variant="primary">
                                    </flux:button>
                                @endcan
                                @can('role.delete')
