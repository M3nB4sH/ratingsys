...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
  <form action="{{ route('sign.directorconfirm') }}" method="POST" class="bg-white p-10 rounded-lg shadow-lg max-w-xl w-full">
    @csrf
    ...
    @endif
    <input type="text" id="rating_id" name="rating_id" value="{{ $rating->id }}" hidden/>
    </div>
    <!-- Signature Pad -->
    <div class="mb-4">
